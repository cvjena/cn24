...
#ifndef CONV_CROSSENTROPYERRORLAYER_H
#define CONV_CROSSENTROPYERRORLAYER_H
...
class CrossEntropyErrorLayer : public Layer, public LossFunctionLayer {
public:
  /**
   * \brief Constructs a CrossEntropyErrorLayer.
   */
  CrossEntropyErrorLayer(const unsigned int classes);

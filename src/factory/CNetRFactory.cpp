...
namespace Conv {
  int CNetRFactory::AddLayers (Net& net, Connection data_layer_connection,
    ...
    // was 48
    auto* layer7 = new FullyConnectedLayer (96, rand());
    ...
    int layer10_id = net.AddLayer (layer10, layer8_id);
  ...
  void CNetRFactory::InitOptimalSettings() {

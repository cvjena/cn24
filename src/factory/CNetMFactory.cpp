...
namespace Conv {
int CNetMFactory::AddLayers (Net& net, Connection data_layer_connection,
  ...
  // auto* layer8 = new DropoutLayer(0.5, layer7, rand());
  auto* layer9 = new TanhLayer();
  // was 96 (tanh) or 192 (relu, all)
  auto* layer10 = new FullyConnectedLayer(192, rand());
  // auto* layer11 = new DropoutLayer(0.2, layer10, rand());
  auto* layer12 = new TanhLayer();
  auto* layer13 = new FullyConnectedLayer (output_classes, rand());
  auto* layer14 = new SoftmaxLayer();
  ...
  int layer9_id = net.AddLayer (layer9, layer7_id);
...
void CNetMFactory::InitOptimalSettings() {

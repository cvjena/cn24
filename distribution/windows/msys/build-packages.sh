...
# (1) CPU BUILD
cd build-cpu
cmake -DCN24_BUILD_PNG=OFF -DJPEG_INCLUDE_DIR=$(pwd)/../libjpeg/include -DJPEG_LIBRARY=$(pwd)/../libjpeg/lib/libjpeg.a -DCMAKE_BUILD_TYPE=Release -G "MSYS Makefiles" ../../../..
make -j12
ctest . --rerun-failed
...
cd ../msys
cd build-gpu
cmake -DCN24_BUILD_PNG=OFF -DJPEG_INCLUDE_DIR=$(pwd)/../libjpeg/include -DJPEG_LIBRARY=$(pwd)/../libjpeg/lib/libjpeg.a -DCMAKE_BUILD_TYPE=Release -DCN24_BUILD_OPENCL=ON -G "MSYS Makefiles" -DCN24_BUILD_OPENCL_CLBLAS=ON -DCLBLAS_INCLUDE_DIR=../../packages/clblas/include -DCLBLAS_LIBRARY=../../packages/clblas/bin/clBLAS.dll ../../../..
make -j12
